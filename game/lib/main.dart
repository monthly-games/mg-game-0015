...
class MyApp extends StatelessWidget {
  ...
  static const gameId = 'MG-0015';
  static const gameTitle = 'Kingdom Rebuild Project';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/enhanced_game': (_) => const EnhancedGameScreen(),
            ...
            child: ConstrainedBox(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 12),
                  FilledButton.icon(
                    key: const ValueKey('enhanced-game'),
                    onPressed: () =>
                        Navigator.of(context).pushNamed('/enhanced_game'),
                    icon: const Icon(Icons.extension_rounded),
                    label: const Text('Enhanced Game'),
...
IconData _loopIcon(String loop) {
  ...
  if (normalized.contains('time') || normalized.contains('era')) {
            ...
            child: ConstrainedBox(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (kOnboardingTutorial.skippable &&
                      stepIndex < steps.length - 1) ...[
                    const SizedBox(height: 8),
                    TextButton(

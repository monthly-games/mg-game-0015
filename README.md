...
Kingdom building simulation

<!-- MG-GAME-SHOWCASE:START -->
## Gameplay Showcase

![Kingdom Rebuild Project gameplay screen](docs/images/gameplay-showcase.png)

**Kingdom Rebuild Project** centers on the **Upgrade and Grow** loop. The player enters from the main menu, reads the active objective and pressure state, performs the core action, banks rewards, then returns through roadmap and retention goals.
...
git clone --recursive https://github.com/monthly-games/mg-game-0015.git

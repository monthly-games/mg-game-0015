...
이 프로젝트는 **킹덤 리빌드**의 Flutter 구현체입니다.
...
| 문서 | 설명 |
|------|------|
| [docs/design/gdd_game_0015.json](docs/design/gdd_game_0015.json) | 게임 디자인 문서 |
...
**HUD 파일**: [game/lib/ui/hud/mg_kingdom_hud.dart](game/lib/ui/hud/mg_kingdom_hud.dart)
